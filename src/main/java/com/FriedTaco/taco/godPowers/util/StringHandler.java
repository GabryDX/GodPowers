...
public class StringHandler {
    ...
    public static String LIST_ENCAGE_DESCRIPTION;
    public static String LIST_CALLOFVALOR_DESCRIPTION;
    ...
    public static String LIST_KAMIKAZE_DESCRIPTION;
    ...
    public static String LIST_ZEUSEVIL_DESCRIPTION;
    ...
    public static String CALLOFVALOR_ADD;
    public static String CALLOFVALOR_REMOVE;
    public static String CALLOFVALOR_SYNTAX;
    ...
    public static String ENCAGE_ADD;
    public static String ENCAGE_CANNOTENCAGE;
    public static String ENCAGE_ENCAGED;
    public static String ENCAGE_PLAYER2;
    public static String ENCAGE_REMOVE;
    public static String ENCAGE_SYNTAXERROR;
    ...
    public static String KAMIKAZE_ADD;
    public static String KAMIKAZE_CANNOTEXPLODE;
    public static String KAMIKAZE_EXPLODED;
    public static String KAMIKAZE_PLAYER2;
    public static String KAMIKAZE_REMOVE;
    public static String KAMIKAZE_SYNTAX;
    ...
    public static String MIDAS_PLAYER2;
    ...
    public static String ZEUSEVIL_ADD;
    public static String ZEUSEVIL_REMOVE;
    public static String ZEUSEVIL_SYNTAX;
